...
export async function getStaticProps() {
  const meta = {
    title: 'Reminder // Max The Stranger',
    description:
  ...
  return (
    <div className="single">
      ...
      {/* <p className="manifesto">
        ...
        It’s your <strong>obligation to help</strong> and inspire them.
        ...
        Being in the <strong>comfort zone is wonderful</strong>, but nothing
        ever grows there. Keep studying. <strong>Keep creating.</strong> Haters
        will come if you have the{' '}
        <strong>audacity to build something new</strong>. Don’t let them define
        you. <strong>Don’t let them stop you.</strong> Just block them and keep
        going. Don’t expect <strong>others to make you happy</strong>. You are
        the only one <strong>responsible for your happiness</strong>. Don’t wait
        ...
        <strong>Do what you wanna do</strong> and do it now. Tick-tock don't
